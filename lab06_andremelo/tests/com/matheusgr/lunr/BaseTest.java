...
class BaseTest {
	...
	void setUp() throws Exception {
		...
		this.documentoController.adicionaDocumento(JAVA_ID, exemplo.sampleJava());
		this.documentoController.adicionaDocumento(HTML_ID, exemplo.sampleHTML());
		this.documentoController.adicionaDocumento(TEXTO1_ID, "um arquivo! texto simples.\r\nuse DUAS linhas apenas.");
		this.documentoController.adicionaDocumento(TEXTO2_ID, "um arquivo! texto simples.\r\nuse TRÊS linhas agora.\r\nMAIS AVANÇO!");
	}
