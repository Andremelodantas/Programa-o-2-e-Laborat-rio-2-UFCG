...
class ValidadorBusca extends ValidadorPadrao {
	...
	/**
	 * Valida o mapa  busca. Não deve ser nulo.
	 * 
	 * @param metadados mapa de metadados a ser validado.
	 */
	public void valida(Map<String, String> metadados) {
		...
		throw new IllegalArgumentException("O mapa de metadados está vazio.");
