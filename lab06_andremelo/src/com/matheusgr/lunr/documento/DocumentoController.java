...
public class DocumentoController {
	...
	/**
	 * Adiciona um documento texto,html ou java, validando o ID e conteúdo para objetos não nulos
	 * e vazios.
	 * 
	 * @param id  ID do documento a ser adicionado.
	 * @param documentoMsg conteudo dentro do documento a ser adicionado.
	 */
	public void adicionaDocumento(String id, String documentoConteudo) {
		this.validador.validacao(id, documentoConteudo);
		if(documentoConteudo.contains("</head>"))this.ds.adicionaDocumento(new DocumentoHtml(id, documentoConteudo));	
		else if(documentoConteudo.contains("@author"))this.ds.adicionaDocumento(new DocumentoJava(id, documentoConteudo));
		else this.ds.adicionaDocumento(new DocumentoTexto(id, documentoConteudo));
